    ...
    public class KiwiSymbolParser : KIWIBaseListener
    {
        ...
        public override void EnterVardecl(KIWIParser.VardeclContext context)
        {
            ...
            if (context.EQUAL() == null)
                this.SymbolTable.addVariable(new BaseSymbole(context.ID().GetText(), t)); // pas de valeur à stocker la valeur de la variable
            else
            {
                ...
                if (context.BIT8() == null)
                {
                    ...
                    this.SymbolTable.addVariable(new BaseSymbole(context.ID().GetText(), t, value));
                }
       ...
       // public override void EnterConstdecl([NotNull] KIWIParser.ConstdeclContext context) { }
    }
}
